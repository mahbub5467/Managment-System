...
<div class="main-area">
    ...
    <aside class="sidebar">
        ...
        <a href="${pageContext.request.contextPath}/training/supervisor-assessment"
           class="sidebar-item">
        ...
        <a
                href="${pageContext.request.contextPath}/training/training-record"
                class="sidebar-item">
    ...
    <main class="content">
        ...
        <div class="content-header">
            ...
            <div>
                ...
                <div class="page-description">
                    ...
                    training schedules, and related training information
                    for CAAB inspectors.
        ...
        <div class="panel department-panel">
            ...
            <div class="department-grid">
                ...
                <a href="${pageContext.request.contextPath}/training/training-pel"
                ...
                <a href="${pageContext.request.contextPath}/library/ops"
                   class="department-folder">
                ...
                <a href="${pageContext.request.contextPath}/library/air"
                   class="department-folder">
                ...
                <a href="${pageContext.request.contextPath}/library/ans"
                   class="department-folder">
                ...
                <a href="${pageContext.request.contextPath}/library/aga"
                   class="department-folder">
                ...
                <a href="${pageContext.request.contextPath}/library/leg"
                   class="department-folder">
                ...
                <a href="${pageContext.request.contextPath}/library/org"
                   class="department-folder">
                ...
                <a href="${pageContext.request.contextPath}/library/ssp"
                   class="department-folder">
